...
-- -----------------------------------------------------
-- Table `db_loja_games`.`db_blog_pessoal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_loja_games`.`db_blog_pessoal` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_produtos_tb_categorias_idx` (`tema_id` ASC) VISIBLE,
